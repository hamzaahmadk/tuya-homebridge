  ...
  getSendParam(name, value) {
    ...
    switch (name) {
      ...
      case Characteristic.ColorTemperature:
        var temperature;
        temperature = Math.floor((500 - value) * (this.function_dp_range.temp_range.max - this.function_dp_range.temp_range.min) / 360 + this.function_dp_range.temp_range.min); // value 140~500
